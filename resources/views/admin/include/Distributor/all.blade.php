          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control select2" name="namadistributor" placeholder="Nama Distributor">
              </div>
              <!-- /.form-group -->
              <div class="form-group">
                <label>Alamat</label>
              ...
              <div class="form-group">
                <label>Kota Asal</label>
               	<input type="text" class="form-control select2" name="kotaasal" id="stok" placeholder="Kota Asal">
                </select>
              </div>
              <!-- /.form-group -->
            </div>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Preview Distributor</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
